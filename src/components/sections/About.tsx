    ...
    <section className="py-20 px-6 bg-[#A4B9C7]">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-5xl font-bold text-[#1E1E1E] mb-8">
            Why We're Here
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="space-y-6">
            ...
            <p className="text-lg text-[#1E1E1E] leading-relaxed">
              But reviving villages takes more than good intentions. It requires smart, simple tools that help small businesses work faster, smarter, and cheaper. That's why we use AI—not to replace people, but to free them. From manual busywork, hidden money leaks, and endless spreadsheets, to meaningful work, richer relationships, and growth that strengthens the whole community.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4">
              <Button 
                variant="ghost"
                className="text-[#305A72] hover:text-[#1E1E1E] text-lg hover:underline"
